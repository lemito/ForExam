...
DEF_LIST(of_paths, List_path *) // ���������� List_of_paths � ���������� ���� List_path
...
List_of_paths *DepthSearch(Graph G, int init, int goal)
{
  ...
  void search()
  {
    ...
    else
    {
      for (int i = 0; i < MAX; i++)
      {
        ...
        {
          List_path_iterator it = List_path_insert(p, List_path_end(p), i); /* ������� � ���� �������� � �������� ������� ��� �������� ���������������� */
          search();
  ...
  List_path_insert(p, List_path_end(p), init); // � ��������� ������-�� insert, � �� Insert � first, � �� First
  search();
  List_path_destroy(&p);
  return result;
}
